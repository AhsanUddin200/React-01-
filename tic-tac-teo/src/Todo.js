  ...
  return (
    <div className="bg-gray-200 min-h-screen flex justify-center">
      <div class="flex flex-col justify-between p-9 leading-normal">
        ...
        <p class="mb-3 font-normal text-black dark:text-black">
          <ul className="mt-4">
            {userData.map((user) => (
              <li key={user.id} className="mb-6 p-14 rounded-lg bg-white shadow">
                <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">User Information</h5>
                ...
                {selectedUser === user.id && (
                  <ul>
                    {todos.map((todo) => (
                      ...
                      >
                        <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Todo Information</h5>
